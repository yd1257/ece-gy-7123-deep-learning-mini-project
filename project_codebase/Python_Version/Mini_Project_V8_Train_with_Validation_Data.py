# -*- coding: utf-8 -*-
"""Copy of ResNet_Mini_Project_V7.9_Yiren_ONLY_Valid_Amex.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1PJk8h8CTcaq6i0frkaZ6q4rI3afWU8FJ
...
# Train Valid Data Loader (Removed the 5000 row for Validation): 50,000 rows of data
...
"""# 10 **Find the Best Performance Model through Validation Accuracy**


*   Get the top valid accuracy model through model .pt file
*   Produce the Valid Accuracy result based on this model
"""

#Valid the best Valid model acc
start_time = "2022-11-22 19:30:33.985494"
f = open("Train_With_Valid_Log/"+str(start_time)+".txt",'a')
...
epoch_end_time = datetime.datetime.now()
# print('For the best model, Valid loss %.6f, Valid acc %.6f'%(valid_loss, valid_acc))
print("-------------------------------------------------")
line_new = "{:>15} {:>15} {:>15}".format(
        "Best Model Saved", "Valid loss", "Valid acc")
print(line_new)
print("=================================================")
line_new = "{:>15} {:>15} {:>15}".format(
    "Best model",
...
print("-------------------------------------------------")
print("\n")
f.write('For the best model, Valid loss %.6f, Valid acc %.6f'%(valid_loss, valid_acc)+'\n')

# Valid the output of the model
predicted_output = model(images)
...
plt.savefig('Train_With_Valid_Log/'+str(start_time)+'_valid_instances.png')